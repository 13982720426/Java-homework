...
public class Estimator{ //主类
	...
	double result=computer.average(a); //【代码 2】computer 调用 average(double x[])方法，将数组 a 传递给参数 x
	System.out.printf("%n");
	System.out.printf("歌手最后得分:%5.3f\n",result);
	computer=new School();
	result= computer.average(b);//【代码 3】computer 调用 average(double x[])方法，将数组 b 传递给参数 x
